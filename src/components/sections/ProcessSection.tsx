...
export const ProcessSection = () => {
  ...
  const steps = [
    {
      id: "01", code: data.step1Code, title: data.step1Title,
      desc: data.step1Desc, details: data.step1Detail, image: data.step1Image,
    },
    {
      id: "02", code: data.step2Code, title: data.step2Title,
      desc: data.step2Desc, details: data.step2Detail, image: data.step2Image,
    },
    {
      id: "03", code: data.step3Code, title: data.step3Title,
      desc: data.step3Desc, details: data.step3Detail, image: data.step3Image,
    }
  ];
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="lg:hidden relative">
            ...
            <div className="flex justify-center gap-4 mt-6">
              <button onClick={() => setActiveStep(prev => (prev === 0 ? steps.length - 1 : prev - 1))} className="w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center hover:bg-slate-50">
              ...
              <div className="flex gap-2 items-center">
               ...
               <button onClick={() => setActiveStep(prev => (prev === steps.length - 1 ? 0 : prev + 1))} className="w-10 h-10 rounded-full bg-white shadow-md flex items-center justify-center hover:bg-slate-50">
